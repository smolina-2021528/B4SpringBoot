package com.sebastianmolina.sportfinal2.controller;

import com.sebastianmolina.sportfinal2.model.User;
import com.sebastianmolina.sportfinal2.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<?> getUserById(@PathVariable Integer id){
        ...
        if (u == null) return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("error", "No se encontro el usuario"));
    ...
    public ResponseEntity<?> updateUser(@PathVariable Integer id, @Valid @RequestBody User user){
        ...
        if (updated == null) return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("error", "No se encontro el usuario"));
